...
1. **Bootc container image**: [ghcr.io/luisarizmendi/bootc-rhel-kvm:{label}](https://github.com/luisarizmendi/bootc-images/pkgs/container/bootc-rhel-kvm)
2. **Artifact container image**: [ghcr.io/luisarizmendi/bootc-rhel-kvm-anaconda-iso:{label}](https://github.com/luisarizmendi/bootc-images/pkgs/container/bootc-rhel-kvm-anaconda-iso)
...
mkdir artifacts
podman create --name temp-container ghcr.io/luisarizmendi/bootc-rhel-kvm-anaconda-iso:v1-amd64
